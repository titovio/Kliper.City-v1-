  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.18.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.18.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.18.tgz':
    resolution: {integrity: sha512-rfGnTGgSStBcH16b2VYSIpDe6CTVqcsLyMX8Ft0wa8v2idCqEzOrkCdstkNGVaf0Msxbff+c2tu7SJf6eXQZXA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.18.tgz}
    version: 2.8.18
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
