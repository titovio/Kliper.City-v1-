...
| Product / UX Lab | гипотезы продукта, улучшение страниц, v1/v2 сценарии, ценность для пользователей и компаний | `docs/*` product/UX reports, ТЗ для рабочих чатов | менять код, запускать UI-правки, обещать backend/auth/CRM без решения |
...
9. Product / UX Lab предлагает новую функцию, CTA, onboarding или социальный сценарий к реализации.
